                                ...
                                <tbody>
                                    @foreach($order_details as $or)
                                        <tr>
                                            <td ></td>
                                            <td class="no">
                                                <img src="{{ asset('storage/images/'. $or->product_image ) }}" width="100px" height="100px">
                                            </td>
                                            <td class="text-left">
                                                <h3>
                                                    {{ $or->product_name }}
                                            ...
                                            <td class="unit">{{ number_format($or->price) }} VNĐ</td>
                                            <td class="qty">{{ $or->quantity }}</td>
                                            <td class="total">{{ number_format($or->price*$or->quantity) }} VNĐ</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format($order->Total_selling_price) }} VNĐ</td>
                                    </tr>
                                </tfoot>
                            </table>
