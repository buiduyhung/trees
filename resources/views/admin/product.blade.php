                    ...
                    <div class="card-body">
                        ...
                        <div class="clearfix">
                            ...
                            <p class="mb-0 float-start import_price" style="display: none;">
                                {{ number_format($product1->import_price) }} VNĐ
                            </p>
                            <p class="mb-0 float-start export_price" style="display: none;">
                                {{ number_format($product1->export_price) }} VNĐ
                            </p>
...
<script>
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            productPrice.textContent = `Giá nhập: ${number_format(import_price)} VNĐ`;
            productDescription.innerHTML  = description;
            exportPrice.textContent = `Giá xuất: ${number_format(export_price)} VNĐ`;
            openPopup();
        });
    });
                                        ...
                                        <div class="border border-3 p-4 rounded">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="export_price" class="form-control" id="inputCostPerPrice" value="${number_format(export_price)} VNĐ" placeholder="00.00">
                                                </div>
                                                <div class="col-12">
