                        ...
                        <div class="col-lg-12">
                            <div class="header-middle-wrap position-relative">
                                ...
                                <div class="col-md-3 offset-md-2">
                                    <form class="form-inline d-flex" method="POST" action="{{ route('home.search') }}">
                                        @csrf
                                        <input class="form-control mr-sm-2" name="keywords" type="search" aria-label="Search">
                                        <button class="btn btn-outline-success my-2 my-sm-0 mx-1" type="submit" style="width: 150px">Tìm kiếm</button>
                                    </form>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 pt-40">
                            <div class="footer-contact-info">
                                <h3 class="footer-widget-title">Liên hệ qua hotline</h3>
                                <a class="number" href="tel://0942603115">0364544956</a>
                                <div class="address">
